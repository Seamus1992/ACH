...
dforiginal.to_excel(r'C:\Users\SéamusPeareBartholdy\Documents\GitHub\ACH\Fysisk data\samlet gps data.xlsx', index=False)
dforiginal = pd.read_excel(r'C:\Users\SéamusPeareBartholdy\Documents\GitHub\ACH\Fysisk data\samlet gps data.xlsx')
writer = pd.ExcelWriter(r'C:\Users\SéamusPeareBartholdy\Documents\GitHub\ACH\Fysisk data\samlet gps data.xlsx', engine='xlsxwriter')
...
writer.close()
dforiginal = pd.read_excel(r'C:\Users\SéamusPeareBartholdy\Documents\GitHub\ACH\Fysisk data\samlet gps data.xlsx',decimal=',')
Ugenummer = dforiginal['Date'].apply(lambda x: x.isocalendar()[1])
dforiginal.insert(loc = 48, column = 'Ugenummer', value= Ugenummer)
dforiginal.to_csv(r'C:\Users\SéamusPeareBartholdy\Documents\GitHub\ACH\Fysisk data\samlet gps data.csv', index=False)
os.remove(r'C:\Users\SéamusPeareBartholdy\Documents\GitHub\ACH\Fysisk data\samlet gps data.xlsx')
print('GPS færdig')
